        ...
        <div class="p-8 bg-white shadow mt-15">
            <div class="mt-20 text-center border-b pb-12">
                <div class="p-8 rounded border border-gray-200">
                    <h1 class="font-medium text-3xl">Send Money</h1>
                    ...
                    <form action="{{ route('user-send-money') }}" method="POST">
                        ...
                        <div class="mt-8 grid lg:grid-cols-2 gap-4">
                            <div> <label for="acc" class="text-sm text-gray-700 block mb-1 font-medium">Enter Account
                                    Number</label>
                                <input type="text" name="accnum" id="acc"
                        ...
                        <div class="space-x-4 mt-8"> <button type="submit"
                                class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50">Send</button>
